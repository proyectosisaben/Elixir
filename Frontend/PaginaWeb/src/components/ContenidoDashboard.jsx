    ...
    <main className='seccion-panel-lateral-tarjetas-seguimiento-de-compras'>
      <div className='todo-el-contenido-de-la-dashboard'>
          ...
          <div className='contenedor-parte-2-dashboard'>
            <div className='panel-lateral-interior-titulos'>
              <div className='contenedor-panel-lateral-interior-y-icono'>
                ...
                <h1 
                  className='titulo-panel-lateral-interior'
                  onClick={() => setTabActiva('dashboard')}
                  style={{ cursor: 'pointer', fontWeight: tabActiva === 'dashboard' ? 'bold' : 'normal' }}
                >
                  Dashboard
                </h1>
              </div>
              ...
              <div className='contenedor-panel-lateral-interior-y-icono'>
                ...
                <h1 
                  ...
                  style={{ cursor: 'pointer', fontWeight: tabActiva === 'reportes' ? 'bold' : 'normal' }}
                >
        ...
        {tabActiva === 'dashboard' ? (
          ...
          <section className='todo-contenido-tarjetas-ingreso-dashboard' style={{ flex: 1 }}>
            <ReportesFinancieros />
          </section>
        )}
      </div>
