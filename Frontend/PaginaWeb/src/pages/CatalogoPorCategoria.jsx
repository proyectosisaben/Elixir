...
function CatalogoPorCategoria() {
  ...
  const handleEliminarProducto = async (productoId) => {
    if (!window.confirm('�Est�s seguro de que deseas eliminar este producto?')) {
      return;
    }
  ...
  return (
    <div className="container-fluid py-5" style={{ backgroundColor: 'var(--light-bg)' }}>
        {/* Bot�n para crear producto - Solo Admin Sistema */}
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginBottom: '15px' }}>
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: 'var(--primary-color)' }}>Stock M�nimo:</label>
                  <input
                    type="number"
                    ...
                    placeholder="Stock m�nimo (default: 5)"
                    required
                  />
                </div>
              </div>
              ...
              <div style={{ marginBottom: '15px' }}>
                <label style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold', color: 'var(--primary-color)' }}>Categor�a:</label>
                <select
      ...
      <div className="container">
        <h1 className="fw-bold mb-5 text-center" style={{ color: 'var(--primary-color)' }}>
          <i className="fas fa-shop"></i> Cat�logo de Licores
        </h1>
        ...
        {filtrosAplicados && Object.values(filtrosAplicados).some(v => v) && (
          <div className="alert alert-info mb-4">
            <strong>Resultados:</strong> Se encontraron {productosFiltrados.length} producto{productosFiltrados.length !== 1 ? 's' : ''} que coinciden con tu b�squeda
          </div>
        )}
        ...
        {productosFiltrados.length === 0 ? (
          <div className="alert alert-warning mt-5">
            <i className="fas fa-inbox"></i> No se encontraron productos que coincidan con tu b�squeda
          </div>
        ) : (
